...
public class Elevator extends SubsystemBase {
  ...
  private final PIDController ElevatorPID = new PIDController(.1, 0, 0.005);
 ...
 private final RelativeEncoder ElevatorEncoder  ;
  /** Creates a new Elevator. */
   public Elevator() {
    ...
    ElevatorSparkMaxConfig.encoder.positionConversionFactor(1).velocityConversionFactor(1);
    //setting the conversion factor for the encoder
...
public void setSetPoint(double setPointrotations){
  ElevatorPID.setSetpoint(setPointrotations);
}
  @Override
